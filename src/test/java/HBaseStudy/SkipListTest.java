...
public class SkipListTest {
    ...
    public void init(){
        ...
        for(long i = 1;i<=5;i++){
            skipList.insertValue(i);
            String str = skipList.printAllNodes();
...
//        skipList.setLevel(2);
    ...
    //@Test
    public void testRemoveNodeByScore(){
        long score = 1;
        boolean res = skipList.removeByScore(score);
    ...
    public void testInsertValue(){
        long score = 7;
        Node newNode = skipList.insertValue(score);
        String str = skipList.printAllNodes();
        System.out.println(str);
        score = 6;
        newNode = skipList.insertValue(score);
        str = skipList.printAllNodes();
        System.out.println(str);
    }
